package com.supersweet.luck.banner;
...
public class BannerView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setData(List<String> urls, String sex) {
        this.urls = urls;
        count = urls.size();
        if (adapter == null) {
            adapter = new MyAdapter(urls,sex);
        }
        init();
    }
    ...
    class MyAdapter extends PagerAdapter {
        ...
        public MyAdapter(List<String> adUrls, String sex) {
            this.adUrls = adUrls;
            this.sex = sex;
        }
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            if (adUrls.size() != 0) {
                ...
                GlideLocalImageUtils.displayBigOrSmallShadowImage(MyApplication.getContext(), imageView,sex,currentUrl, "big");
