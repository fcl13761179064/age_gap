...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    private int TextSelectedColor = Color.parseColor("#7857EF");
    ...
    //列表文字选中的颜色
    private int listTextSelectedColor = Color.parseColor("#7857EF");
    //列表icon资源
    ...
    private class Line extends LinearLayout {
        ...
        private int SelectedColor = Color.parseColor("#7857EF");
                    ...
                    if (onItemClickListener != null) {
                        ...
                        if (tabs.size() == 2) {
                            if (tabIndex + 1 == 2) {
                                resetAllTabs(tabIndex);
                                line.setIndex(tabIndex);
                                tabs.get(tabIndex).setText("City");
                                tabs.get(tabIndex).setSelected(true);
                            } else if (tabIndex + 1 < tabs.size()) {
                                tabIndex++;
                                resetAllTabs(tabIndex);
                                line.setIndex(tabIndex);
                                tabs.get(tabIndex).setText("States");
                                tabs.get(tabIndex).setSelected(true);
                            }
                        } else {
                            if (tabIndex + 1 == 2) {
