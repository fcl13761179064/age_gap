package com.supersweet.luck.yuyin;
...
public class AudioRecordButton extends AppCompatButton implements AudioManager.AudioStageListener {
    ...
    public void setAudioFinishRecorderListener(AudioFinishRecorderListener listener, FragmentActivity activity) {
        mListener = listener;
    ...
    private void changeState(int state) {
        ...
        if (mCurrentState != state) {
            ...
            switch (mCurrentState) {
                case STATE_NORMAL:
                    setBackgroundResource(R.drawable.talk);
    ...
    public void checkPermissionVoice() {
        ...
        permissions.requestEachCombined(Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    public void accept(Permission permission) throws Exception {
                        ...
                        if (permission.granted) {//全部同意后调用
                            ...
                            new AlertDialog.Builder(activity)
                                    .setMessage("In order to send voice messages, Lucky needs to access the microphone.")
