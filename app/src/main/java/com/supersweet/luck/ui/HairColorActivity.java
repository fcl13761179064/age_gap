...
public class HairColorActivity extends BasicActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_hair_color;
    }
        ...
        tv_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(hair)) {
                    CustomToast.makeText(HairColorActivity.this, "hair is required", R.drawable.ic_toast_warming).show();
                    return;
                }
                Intent intent = new Intent(HairColorActivity.this, RelationShipActivity.class);
                intent.putExtras(getIntent());
                intent.putExtra("hairColor",hair);
