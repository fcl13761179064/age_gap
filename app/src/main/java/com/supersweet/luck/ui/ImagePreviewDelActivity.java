...
import com.supersweet.luck.mvp.present.DeletePicturePresenter;
import com.supersweet.luck.mvp.view.DeletePictureView;
import com.supersweet.luck.utils.NavigationBarChangeListener;
...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    private void showDeleteDialog() {
        NoTitleDialog
                .newInstance(new NoTitleDialog.Callback() {
                    ...
                    public void onDone(NoTitleDialog dialog) {
                        ...
                        if (mImageItems.size() > 0) {
                            ...
                            OkGo.<String>get(Constance.getBaseUrl() + Constance.Delete_Img).tag(this)
                                    .headers("token", sava_token)
                                    .params("albumId", mImageItems.get(mCurrentPosition - 1).id)
                                    .execute(new StringCallback() {
                                        ...
                                        public void onSuccess(Response<String> response) {
                                            if (response.isSuccessful() && response.code() == 200) {
                                                Gson gson = new Gson();
                                                ToastUtils.showLongToast("Delete Success");
                ...
                .setContent("Are you sure to delete?")
