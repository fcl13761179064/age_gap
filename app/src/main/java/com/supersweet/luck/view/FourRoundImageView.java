package com.supersweet.luck.view;
...
public class FourRoundImageView extends AppCompatImageView {
    ...
    public FourRoundImageView(Context context) {
        this(context, null);
    }

    public FourRoundImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public FourRoundImageView(Context context, AttributeSet attrs, int defStyle) {
