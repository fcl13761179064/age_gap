...
public class PagerChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public static PagerChangeListener newInstance( ImageView originImage, ImageView outgoingImage) {
        ImageAnimator imageAnimator = new ImageAnimator(originImage, outgoingImage);
